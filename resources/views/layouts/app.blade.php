...
<head>
   ...
   <link href="{{ asset('css/app.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('css/accesorios/accesorios.css') }}" rel="stylesheet">
    <link href="{{ asset('css/accesorios/agregarAccesorios.css') }}" rel="stylesheet">
    <link href="{{ asset('css/accesorios/updateAccesorios.css') }}" rel="stylesheet">

    <link href="{{ asset('css/telefonos/agregarTelefonos.css') }}" rel="stylesheet">
    <link href="{{ asset('css/telefonos/listaTelefonos.css') }}" rel="stylesheet">
    <link href="{{ asset('css/telefonos/update.css') }}" rel="stylesheet">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-shop" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item active">
                                ...
                                <!-- termina aqui mi codigo codigo mio -->


                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-key-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <script src="{{asset('js/agregarAccesorio.js')}}"></script>
    <script src="{{asset('js/agregarTelefonos.js')}}"></script>
